const positions = [
  ["14%", "28%"], ["42%", "17%"], ["70%", "30%"],
  ["18%", "64%"], ["48%", "56%"], ["76%", "67%"], ["52%", "34%"]
];

const stack = (name, file, fallback, index) => ({
  name,
...
export const projects = [
  {
    ...
    status: "Draft",
    accent: "#39c951",
    carImage: "/assets/cars/hyundai-kona.avif",
    carAlt: "현대 코나",
    carName: "Kona",
    carYear: "2017",
    ...
    stacks: [
      stack("Python", "python-logo.webp", "Py", 0),
      stack("Cloud signal", "cf.png", "CW", 1),
      stack("Grafana", "grafana-logo.png", "G", 2),
      stack("Board", "monitoring-board.png", "B", 3),
      stack("Slack", "slack-logo.png", "S", 4),
      stack("AWS Graviton", "aws_graviton_logo_58ae94ac0b.png", "AWS", 5)
    ]
  },
  {
    number: "02",
    ...
    accent: "#ff9500",
    carImage: "/assets/cars/hyundai-granada.avif",
    carAlt: "현대 그라나다",
    carName: "Granada",
    carYear: "1970",
    ...
    stacks: [
      stack("Monitoring", "monitoring-board.png", "Mon", 0),
      stack("Grafana", "grafana-logo.png", "G", 1),
      stack("Telegraf", "telegraf.png", "T", 2),
      stack("OpenTelemetry", "opentelemetry.png", "OTel", 3),
      stack("CloudFront", "cloudfront.png", "CF", 4),
      stack("Slack", "slack-logo.png", "S", 5),
      stack("Python", "python-logo.webp", "Py", 6)
    ]
  },
  {
    number: "03",
    ...
    stacks: [stack("AWS Graviton", "aws_graviton_logo_58ae94ac0b.png", "AWS", 0), stack("ARM", "ARM_logo.svg", "ARM", 1), stack("AMD", "AMD_Logo.svg.webp", "AMD", 2), stack("Grafana", "grafana-logo.png", "G", 3), stack("Python", "python-logo.webp", "Py", 4), stack("Slack", "slack-logo.png", "S", 5)]
  },
  {
    number: "04",
    section: "Infrastructure",
    ...
    stacks: [stack("Board", "monitoring-board.png", "B", 0), stack("Slack", "slack-logo.png", "S", 1), stack("Python", "python-logo.webp", "Py", 2), stack("CloudFront", "cloudfront.png", "CF", 3), stack("OpenTelemetry", "opentelemetry.png", "OTel", 4), stack("Grafana", "grafana-logo.png", "G", 5)]
  },
  {
    number: "05",
    section: "Infrastructure",
    ...
    status: "FinOps",
    accent: "#0a84ff",
    carImage: "/assets/cars/hyundai-ioniq6.avif",
    carAlt: "현대 아이오닉 6",
    carName: "IONIQ 6",
    carYear: "2022",
    ...
    stacks: [stack("CloudFront", "cloudfront.png", "CF", 0), stack("Board", "monitoring-board.png", "B", 1), stack("Python", "python-logo.webp", "Py", 2), stack("Grafana", "grafana-logo.png", "G", 3), stack("Slack", "slack-logo.png", "S", 4), stack("AWS Graviton", "aws_graviton_logo_58ae94ac0b.png", "AWS", 5)]
  }
];
